    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-indigo-800 via-blue-700 to-kasgreen text-white py-16 md:py-32">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-center">
        <motion.h2
          ...
          className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold mb-4 md:mb-6 leading-snug md:leading-tight cursor-pointer hover:underline decoration-white/50 underline-offset-4 transition"
        >
          Kaspa Forum
        </motion.h2>
        <motion.p
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <motion.button
            ...
            className="bg-transparent border-2 border-white/60 text-white px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-full text-sm sm:text-base md:text-xl font-bold hover:bg-white/10 transition"
          >
